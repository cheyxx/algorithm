...
void
Sony::on() {
    std::cout << "sony tv on" << std::endl;
    
}

void
Sony::off() {
    std::cout << "sony tv off" << std::endl;
    
}

void 
Sony::tuneChannel() {
    std::cout << "sony tv tuneChannel" << std::endl;
...
void
RCA::on() {
    std::cout << "RCA tv on" << std::endl;
    
}

void
RCA::off() {
    std::cout << "RCA tv off" << std::endl;
    
}

void
RCA::tuneChannel() {
    std::cout << "RCA tv tuneChannel" << std::endl;
...
void
ConcreteRemoteLaser::setChannel() {
...
void
ConcreteRemoteInfrareRay::setChannel() {
